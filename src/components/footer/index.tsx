    ...
    <footer>
      <div className="In_our_stores">
        <div className="In_our_stores_header">
          <img
            src={
              'https://github.com/Nikolinc/book_shop/blob/main/assets/books.png?raw=true'
            }
            alt=""
            height={'50px'}
          />
      ...
      <div className="In_the_online_store">
        <div className="In_the_online_store_header">
          <img
            src={
              'https://github.com/Nikolinc/book_shop/blob/main/assets/shopping_cart.png?raw=true'
            }
            alt=""
            height={'50px'}
          />
      ...
      <div className="Subscribe_to_news">
        <div className="Subscribe_to_news_header">
          <img
            src={
              'https://github.com/Nikolinc/book_shop/blob/main/assets/letter.png?raw=true'
            }
            alt=""
            height={'50px'}
          />
