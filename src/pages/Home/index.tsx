    ...
    return(
        ...
        <div className="home">     
           ...
           <div className="home_info">
                ...
                <div className="info_headers"><h1>Beware of  expensive books</h1><h3>We only have the best books</h3></div>
                <div className="bound"></div>       
...
function Novelties(props:{image:string}){
    return(
        <div className="novelty"><img src={[props.image]} alt="cover" height={"250px"} /></div>
    );
}